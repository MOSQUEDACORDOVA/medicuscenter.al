...
<body>
	...
	<div id="langSelect" style="text-align:center;">
		<a href="https://medicuscenter.al?la=eng"><img src="language/flags/eng.png" alt="<?=$lang['lang-eng'];?>" title="<?=$lang['lang-eng'];?>" /></a> 
		<a href="https://medicuscenter.al?la=it"><img src="language/flags/ita.png" alt="<?=$lang['lang-it'];?>" title="<?=$lang['lang-it'];?>" /></a> 
			<!--<a href="https://medicuscenter.al?la=fre"><img src="language/flags/fra.png" alt="<?=$lang['lang-fre'];?>" title="<?=$lang['lang-fre'];?>" /></a> -->
			<!--<a href="https://medicuscenter.al?la=ger"><img src="language/flags/ger.png" alt="<?=$lang['lang-ger'];?>" title="<?=$lang['language/lang/ger.php'];?>" /></a> -->
	</div>	
</div>
	
	<!-- Start Header -->
	<header class="hdr hdr-position-relative">
		<!-- Start Header Top Section -->
		<div id="hdr-top-wrapper" class="bg-transparent">
